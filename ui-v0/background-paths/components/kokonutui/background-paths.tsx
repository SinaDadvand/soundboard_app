...
function FloatingPaths({
  ...
  // Use useRef with a stable array instead of generating random values during render
  ...
  // Initialize paths data only once on client side
  useEffect(() => {
    if (pathsData.current.length === 0) {
      pathsData.current = Array.from({ length: 36 }, (_, i) => ({
        id: i,
        ...
        width: 0.5 + i * 0.03,
        // Generate stable durations based on index
        duration: 15 + (i % 10),
      }))
    }
  }, [position])
...
export default function BackgroundPaths({
  ...
  const soundButtons = [
    { name: "Kick", delay: 1.1, color: "#FF5555" },
    { name: "Snare", delay: 1.15, color: "#FF8A5E" },
    { name: "Hi-Hat", delay: 1.2, color: "#FFB454" },
    { name: "Clap", delay: 1.25, color: "#FFD700" },
    { name: "Crash", delay: 1.3, color: "#F9F871" },
    { name: "Tom", delay: 1.35, color: "#A5FF8F" },
    { name: "Bass", delay: 1.4, color: "#64DFDF" },
    { name: "Synth", delay: 1.45, color: "#56CFE1" },
    { name: "Piano", delay: 1.5, color: "#48BFE3" },
    { name: "Strings", delay: 1.55, color: "#5390D9" },
    { name: "Vocal", delay: 1.6, color: "#6930C3" },
    { name: "FX", delay: 1.65, color: "#9D4EDD" },
    { name: "Ambient", delay: 1.7, color: "#C77DFF" },
  ]
